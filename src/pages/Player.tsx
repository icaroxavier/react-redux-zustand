        ...
        <div className="flex w-[1100px] flex-col gap-6">
            ...
            <main className="relative flex overflow-hidden rounded-lg border border-zinc-800 bg-zinc-900 shadow pr-80">
                ...
                <aside className="divide-y-2 divide-zinc-900 w-80 border-l border-zinc-800 bg-zinc-900 absolute top-0 bottom-0 right-0 overflow-y-auto scrollbar-thin scrollbar-track-zinc-950 scrollbar-thumb-zinc-800">
                    <Module title="Fundamentos do react" amountOfLessons={12} moduleIndex={0} />
                    <Module title="Fundamentos do react" amountOfLessons={12} moduleIndex={1} />

                    <Module title="Fundamentos do react" amountOfLessons={12} moduleIndex={2} />
